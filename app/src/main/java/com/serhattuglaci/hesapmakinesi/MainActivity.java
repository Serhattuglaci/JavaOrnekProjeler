package com.serhattuglaci.hesapmakinesi;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button button_one, button_two, button_there, button_plus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_there=(Button) findViewById(R.id.button_there);
        ...
        button_there.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
